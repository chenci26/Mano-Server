...
(114, '陳辛蒂', 100, 120, '2020-07-03 14:50:58', '2020-07-03 14:50:58');
...
(23, 15908927010, '陳辛蒂', '手摘', '和平東路', '高雄市', '鳳山區', 878, '0987778888', '0126cloud@gmail.com', '08419f95f54ba7772a69a52ce1114111bf996b10', '貨到付款', '大有路一段92號', '2020-04-29 00:00:00', '1593759604786.jpg', '2020-04-29 12:11:57', '2020-07-04 23:56:42'),
...
(161, 1593632482379, 'M010', '陳辛蒂', '0987778777', '南投縣', '埔里鎮', '大有路一段92號', '2020-07-02 11:41:22', '已出貨', 'ATM轉帳', '未付款', '2020-07-02 03:41:22', 0, 0, 1850, '', '2020-07-03 14:12:07'),
...
(163, 1593633078970, 'M010', '陳辛蒂', '0987778777', '南投縣', '埔里鎮', '大有路一段92號', '2020-07-02 11:51:18', '已出貨', '信用卡', '已付款', '2020-07-02 03:51:18', 0, 25, 475, '', '2020-07-03 14:12:26'),
...
(165, 1593648616190, 'M010', '陳辛蒂', '0987778777', '南投縣', '埔里鎮', '大有路一段92號', '2020-07-02 16:10:16', '已出貨', 'LinePay', '未付款', '2020-07-02 08:10:16', 100, 0, 1630, '', '2020-07-03 14:12:32'),
(166, 1593759286447, 'M010', '陳辛蒂', '0987778888', '南投縣', '埔里鎮', '大有路一段92號', '2020-07-03 22:54:46', '未出貨', '信用卡', '已付款', '2020-07-03 14:54:46', 150, 506, 2684, '新竹市仁愛路四段', '2020-07-03 14:54:46'),
(167, 1593760688996, 'M010', '陳辛蒂', '0987778888', '南投縣', '埔里鎮', '大有路一段92號', '2020-07-03 23:18:08', '未出貨', '貨到付款', '未付款', '2020-07-03 15:18:09', 100, 44, 836, '', '2020-07-03 15:18:09'),
(168, 1593766893269, 'M010', '陳辛蒂', '0987778888', '高雄市', '鳳山區', '大有路一段92號', '2020-07-04 01:01:33', '未出貨', '貨到付款', '未付款', '2020-07-03 17:01:33', 100, 18, 162, '', '2020-07-03 17:01:33'),
(169, 1593768438933, 'M010', '陳辛蒂', '0987778888', '高雄市', '鳳山區', '大有路一段92號', '2020-07-04 01:27:18', '未出貨', 'LinePay', '未付款', '2020-07-03 17:27:18', 100, 168, 252, '', '2020-07-03 17:27:18');
...
(13, '15908927010', 'D311', 1, '2020-06-25 20:03:37', '2020-06-25 00:14:30'),
...
(26, '15908927010', 'D307', 0, '2020-06-27 22:39:23', '2020-06-25 00:14:37'),
...
--
ALTER TABLE `comment`
  MODIFY `cid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
...
--
ALTER TABLE `forget_password`
  MODIFY `fId` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `item_tracking`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=115;
...
--
ALTER TABLE `member`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `orderId` int(5) NOT NULL AUTO_INCREMENT COMMENT '訂單編號', AUTO_INCREMENT=170;

--
-- AUTO_INCREMENT for table `order_lists`
--
ALTER TABLE `order_lists`
  MODIFY `orderListId` int(10) NOT NULL AUTO_INCREMENT COMMENT '明細編碼', AUTO_INCREMENT=299;

--
-- AUTO_INCREMENT for table `order_payment`
--
ALTER TABLE `order_payment`
  MODIFY `orderPaymentId` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
